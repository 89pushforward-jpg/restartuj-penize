  ...
  return <>
    <section id="nabidka" className="bg-white px-5 py-22 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="offer-alternatives-heading"><p className="eyebrow">Všechny tři vrstvy v jednom</p><h3>Když nechcete vybírat jen jeden problém, navazuje kompletní knihovna.</h3></div>
