  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <section id="hlavni-knihy" className="bg-white px-5 py-22 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center"><p className="eyebrow">Jádro celé knihovny</p><h2 className="section-title">Dvě hlavní knihy promění nesouvislé rady v systém, podle kterého se dokážete rozhodovat.</h2></div>
      ...
      <section id="obsah" className="bg-brand-navy px-5 py-22 text-white lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 text-center"><a href="#nabidka" className={primaryCta}>Získat kompletní knihovnu 13 PDF <ArrowRight data-icon="inline-end" /></a></div>
        </div>
      </section>
